...
_STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "chat_perm_full": "🔓 完全访问",
        "chat_perm_tip": "完全访问：跳过高风险操作确认（不含 GUI，GUI 需在安全中心单独开启）",
        "chat_stop": "停止",
        "chat_stop_tip": "停止生成",
        "chat_attach": "＋",
        "chat_attach_tip": "附加文件",
        "chat_network_on_tip": "联网已开启：可使用 web_search / web_fetch 搜索互联网",
        "chat_network_off_tip": "联网已关闭：点击开启网络访问",
        "chat_network_on_status": "联网已开启",
        "chat_network_off_status": "联网已关闭",
        "chat_workspace_tip": "工作目录",
        "chat_local_search": "本地检索（不调用模型）",
        "send_enter": "发送 (Enter)",
        "send_ctrl_enter": "发送 (Ctrl+Enter)",
        "send_busy_tip": "单击或 Enter 发送引导；悬停选择发送方式",
        "send_menu_guide": "引导发送（不中断）",
        "send_menu_normal": "正常发送（中断并重发）",
        "send_menu_guide_disabled_tip": "当前没有进行中的任务",
        "guidance_applied": "引导已发送，模型将在下一步调整方向",
        "guidance_failed": "引导发送失败，请重试",
        "mode_ask": "问一问",
        "mode_craft": "做一做",
        "mode_plan": "想一想",
        # --- 菜单 ---
    ...
    "en": {
        ...
        "chat_perm_tip": "Full access skips high-risk confirmations (GUI automation is a separate setting in Security)",
        "chat_stop": "Stop",
        "chat_stop_tip": "Stop generation",
        "chat_attach": "＋",
        "chat_attach_tip": "Attach files",
        "chat_network_on_tip": "Web access on — web_search / web_fetch available",
        "chat_network_off_tip": "Web access off — click to enable network tools",
        "chat_network_on_status": "Web access enabled",
        "chat_network_off_status": "Web access disabled",
        ...
        "send_busy_tip": "Click or Enter to guide; hover for send options",
        "send_menu_guide": "Guide (no interrupt)",
        "send_menu_normal": "Send normally (interrupt & restart)",
        "send_menu_guide_disabled_tip": "No task is running",
        "guidance_applied": "Guidance sent; the model will adjust on the next step",
        "guidance_failed": "Failed to send guidance, please retry",
        "mode_ask": "Ask",
        "mode_craft": "Craft",
        "mode_plan": "Plan",
        "menu_app": "{app_name}",
